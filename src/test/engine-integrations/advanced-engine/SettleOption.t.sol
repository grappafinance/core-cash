...
contract TestSettleCall is AdvancedFixture {
    ...
    function testSellerCanClearDebtIfExpiresOTM() public {
        ...
        (uint256 shortCallId,, uint64 shortCallAmount,, uint80 collateralAfter, uint8 collateralIdAfter) =
...
contract TestSettleCoveredCall is AdvancedFixture {
    ...
    function setUp() public {
        ...
        tokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productIdEthCollat, expiry, strike, 0);
        ActionArgs[] memory actions = new ActionArgs[](2);
...
contract TestSettlePut is AdvancedFixture {
    ...
    function testSellerCanClearDebtIfExpiresOTM() public {
        ...
        //margin account should be reset
        (, uint256 shortPutId,, uint64 shortPutAmount, uint80 collateralAfter, uint8 collateralIdAfter) =
            engine.marginAccounts(address(this));
...
contract TestSettleETHCollateralizedPut is AdvancedFixture {
    ...
    function setUp() public {
        ...
        tokenId = getTokenId(SettlementType.CASH, TokenType.PUT, productIdEthCollat, expiry, strike, 0);
        ActionArgs[] memory actions = new ActionArgs[](2);
        actions[0] = createAddCollateralAction(wethId, address(this), depositAmount);
        // give option to alice
        actions[1] = createMintAction(tokenId, alice, amount);
...
contract TestSettleCallSpread is AdvancedFixture {
    ...
    function setUp() public {
        ...
        tokenId = getTokenId(SettlementType.CASH, TokenType.CALL_SPREAD, productId, expiry, longStrike, shortStrike);
        ActionArgs[] memory actions = new ActionArgs[](2);
        actions[0] = createAddCollateralAction(usdcId, address(this), depositAmount);
        // give option to alice
        actions[1] = createMintAction(tokenId, alice, amount);
...
contract TestSettlePutSpread is AdvancedFixture {
    ...
    function setUp() public {
        ...
        tokenId = getTokenId(SettlementType.CASH, TokenType.PUT_SPREAD, productId, expiry, longStrike, shortStrike);
        ActionArgs[] memory actions = new ActionArgs[](2);
        actions[0] = createAddCollateralAction(usdcId, address(this), depositAmount);
        // give option to alice
        actions[1] = createMintAction(tokenId, alice, amount);
...
contract TestSettleBTCCollateralizedCall is AdvancedFixture {
    ...
    function setUp() public {
        ...
        wbtcbackedTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, wbtcBackedProductId, expiry, strike, 0);
...
contract TestBatchSettleCall is AdvancedFixture {
    ...
    function setUp() public {
        ...
        tokenIds[0] = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikes[0], 0);
        tokenIds[1] = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikes[1], 0);
        tokenIds[2] = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikes[2], 0);
    ...
    function testCannotSettleWithWrongArgumentLengths() public {
        ...
        badIds[0] = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikes[0], 0);
...
contract TestBatchSettleMultipleProduct is AdvancedFixture {
    ...
    function setUp() public {
        ...
        // 4000 put
        // 4500 call
        tokenIds[0] = getTokenId(SettlementType.CASH, TokenType.CALL, productIdEthCollat, expiry, strikes[0], 0);
        tokenIds[1] = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, strikes[1], 0);
        tokenIds[2] = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikes[2], 0);
...
contract TestSettlementEdgeCase is AdvancedFixture {
    ...
    function testRolloverPositionForShort() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry + 14 days, strike, 0);
