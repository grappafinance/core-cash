...
contract TestRemoveCollateral_AM is AdvancedFixture {
    ...
    function testCanRemoveExtraCollateralBeforeSettlement() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.PUT_SPREAD, productId, expiry, strikeHigher, strikeLower);
    ...
    function testCannotRemoveCollateralBeforeSettleExpiredShort() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.CALL_SPREAD, productId, expiry, strike, strikeHigher);
