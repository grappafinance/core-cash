...
contract TestMergeOption is AdvancedFixture {
    ...
    function setUp() public {
        ...
        existingTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikePrice, 0);
    ...
    function testMergeCallChangeStorage() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, higherStrike, 0);
    ...
    function testCannotMergeWithWrongShortId() public {
        ...
        uint256 wrongShort = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, 2000 * UNIT, 0);
    ...
    function testCannotMergeWithTokenFromDiffExpiry() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry + 1, higherStrike, 0);
        mintOptionFor(address(this), newTokenId, productId, amount);
    ...
    function testCannotMergeWithTokenWithSameStrike() public {
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikePrice, 0);
        mintOptionFor(address(this), newTokenId, productId, amount);
    ...
    function testCannotMergeWithPut() public {
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, strikePrice, 0);
        mintOptionFor(address(this), newTokenId, productId, amount);
    ...
    function testCannotMergeWithDiffProduct() public {
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productIdEthCollat, expiry, strikePrice, 0);
    ...
    function testMergeIntoDebitSpreadCanRemoveAllCollateral() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, lowerStrike, 0);
        mintOptionFor(address(this), newTokenId, productId, amount);
