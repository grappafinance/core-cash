...
contract TestSplitCallSpread is AdvancedFixture {
    ...
    function setUp() public {
        ...
        spreadId = getTokenId(SettlementType.CASH, TokenType.CALL_SPREAD, productId, expiry, strikePriceLow, strikePriceHigh);
    ...
    function testSplitCallSpreadCreateNewCallToken() public {
        ...
        // check result
        uint256 expectedTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikePriceHigh, 0);
...
contract TestSplitPutSpread is AdvancedFixture {
    ...
    function setUp() public {
        ...
        spreadId = getTokenId(SettlementType.CASH, TokenType.PUT_SPREAD, productId, expiry, strikePriceHigh, strikePriceLow);
    ...
    function testSplitCallSpreadCreateNewCallToken() public {
        ...
        // check result
        uint256 expectedTokenId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, strikePriceLow, 0);
    ...
    function testCannotSplitPut() public {
        uint256 fakeLongStrike = strikePriceHigh - (50 * UNIT);
        uint256 putId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, fakeLongStrike, 0);
