...
contract TestMintVanillaOption is AdvancedFixture {
    ...
    function testMintCoveredCall() public {
        ...
        uint256 tokenId = getTokenId(DerivativeType.CALL, SettlementType.CASH, productIdEthCollat, expiry, strikePrice, 0);
    ...
    function testMintCallWithBTCCollat() public {
        ...
        uint256 strikePrice = 4000 * UNIT;
        uint256 amount = 1 * UNIT;
        uint256 tokenId = getTokenId(DerivativeType.CALL, SettlementType.CASH, productIdBtcCollat, expiry, strikePrice, 0);
    ...
    function testCannotMintCallWithOtherProductId() public {
        ...
        uint256 tokenId = getTokenId(DerivativeType.CALL, SettlementType.CASH, fakeProductId, expiry, strikePrice, 0);
    ...
    function testMintCallSpread() public {
        ...
        uint256 tokenId = getTokenId(DerivativeType.CALL_SPREAD, SettlementType.CASH, productId, expiry, longStrike, shortStrike);
    ...
    function testMintPut() public {
        ...
        uint256 tokenId = getTokenId(DerivativeType.PUT, SettlementType.CASH, productId, expiry, strikePrice, 0);
    ...
    function testMintPutSpread() public {
        ...
        uint256 tokenId = getTokenId(DerivativeType.PUT_SPREAD, SettlementType.CASH, productId, expiry, longStrike, shortStrike);
    ...
    function testCanMintStraddle() public {
        ...
        uint256 callId = getTokenId(DerivativeType.CALL, SettlementType.CASH, productId, expiry, strikePrice, 0);
        uint256 putId = getTokenId(DerivativeType.PUT, SettlementType.CASH, productId, expiry, strikePrice, 0);
    ...
    function testCanMintStrangle() public {
        ...
        uint256 callId = getTokenId(DerivativeType.CALL, SettlementType.CASH, productId, expiry, 4000 * UNIT, 0);
        uint256 putId = getTokenId(DerivativeType.PUT, SettlementType.CASH, productId, expiry, 2000 * UNIT, 0);
    ...
    function testCannotMintTwoCalls() public {
        ...
        uint256 secondCallId = getTokenId(DerivativeType.CALL, SettlementType.CASH, productId, expiry, 5000 * UNIT, 0);
