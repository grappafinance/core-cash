...
contract TestMintVanillaOption is AdvancedFixture {
    ...
    function testMintCoveredCall() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productIdEthCollat, expiry, strikePrice, 0);
    ...
    function testMintCallWithBTCCollat() public {
        ...
        uint256 strikePrice = 4000 * UNIT;
        uint256 amount = 1 * UNIT;
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.CALL, productIdBtcCollat, expiry, strikePrice, 0);
    ...
    function testCannotMintCallWithOtherProductId() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.CALL, fakeProductId, expiry, strikePrice, 0);
    ...
    function testMintCallSpread() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.CALL_SPREAD, productId, expiry, longStrike, shortStrike);
    ...
    function testMintPut() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, strikePrice, 0);
    ...
    function testMintPutSpread() public {
        ...
        uint256 tokenId = getTokenId(SettlementType.CASH, TokenType.PUT_SPREAD, productId, expiry, longStrike, shortStrike);
    ...
    function testCanMintStraddle() public {
        ...
        uint256 callId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, strikePrice, 0);
        uint256 putId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, strikePrice, 0);
    ...
    function testCanMintStrangle() public {
        ...
        uint256 callId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, 4000 * UNIT, 0);
        uint256 putId = getTokenId(SettlementType.CASH, TokenType.PUT, productId, expiry, 2000 * UNIT, 0);
    ...
    function testCannotMintTwoCalls() public {
        ...
        uint256 secondCallId = getTokenId(SettlementType.CASH, TokenType.CALL, productId, expiry, 5000 * UNIT, 0);
