...
contract TestMergeOption_FM is FullMarginFixture {
    ...
    function setUp() public {
        ...
        existingTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice, 0);
    ...
    function testMergeCall() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, higherStrike, 0);
    ...
    function testCannotMergeByAddingSpread() public {
        uint256 spreadToAdd =
            getTokenId(SettlementType.CASH, TokenType.CALL_SPREAD, pidEthCollat, expiry, strikePrice, strikePrice + 1);
    ...
    function testCannotMergeWithWrongShortId() public {
        ...
        uint256 wrongShort = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, 2000 * UNIT, 0);
    ...
    function testMergeIntoDebitSpreadCanRemoveAllCollateral() public {
        ...
        uint256 newTokenId = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, lowerStrike, 0);
        mintOptionFor(address(this), newTokenId, pidEthCollat, amount);
