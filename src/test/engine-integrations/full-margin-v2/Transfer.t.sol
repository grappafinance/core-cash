...
contract TestTransfer_FMV2 is FullMarginFixtureV2 {
    ...
    function testTransferCollateral() public {
        ...
        (Position[] memory aliceShorts, Position[] memory aliceLongs, Balance[] memory aliceCollaterals) = engine
        ...
        (Position[] memory selfShorts, Position[] memory selfLongs, Balance[] memory selfCollaterals) = engine
