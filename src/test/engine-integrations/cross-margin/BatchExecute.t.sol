...
contract TestBatchExecute_CM is CrossMarginFixture {
    ...
    function setUp() public {
        ...
        tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice * 2, 0);
    ...
    function testMintSpreadChecksCollateralAfterBatch() public {
        ...
        uint256 c2100 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, k1, 0);
        uint256 c2101 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, k2, 0);
