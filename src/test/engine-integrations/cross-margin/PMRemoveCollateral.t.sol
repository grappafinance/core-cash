...
contract TestPMRemoveCollateral_CM is CrossMarginFixture {
    ...
    function testEqualCallSpreadCollateralWithdraw() public {
        ...
        uint256 shortId = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice - strikeSpread, 0);
        uint256 longId = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice, 0);
    ...
    function testEqualPutSpreadCollateralWithdraw() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, strikePrice - strikeSpread, 0);
