...
contract TestMintWithPartialMarginBeta_CM is CrossMarginFixture {
    ...
    function testMintCallWithSimilarCollateral() public {
        ...
        uint256 tokenId1 = getTokenId(SettlementType.CASH, TokenType.CALL, pidLsEthCollat, expiry, strikePrice, 0);
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice, 0);
    ...
    function testMintPutWithSimilarCollateral() public {
        ...
        uint256 tokenId1 = getTokenId(SettlementType.CASH, TokenType.PUT, pidSdycCollat, expiry, strikePrice, 0);
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, strikePrice, 0);
    ...
    function testCannotMintTooLittleCollateral() public {
        ...
        uint256 tokenId1 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, 1000 * UNIT, 0);
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdtSdycCollat, expiry, 2000 * UNIT, 0);
    ...
    function testMintMixedBag() public {
        ...
        uint256 tokenId1 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, 1000 * UNIT, 0);
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdtSdycCollat, expiry, 2000 * UNIT, 0);
        uint256 tokenId3 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, 3000 * UNIT, 0);
