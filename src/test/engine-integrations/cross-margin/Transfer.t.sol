...
contract TestTransfer_CM is CrossMarginFixture {
    ...
    function setUp() public {
        ...
        c4000 = getTokenId(DerivativeType.CALL, SettlementType.CASH, pidEthCollat, expiry, 4000 * UNIT, 0);

        c5000 = getTokenId(DerivativeType.CALL, SettlementType.CASH, pidEthCollat, expiry, 5000 * UNIT, 0);
