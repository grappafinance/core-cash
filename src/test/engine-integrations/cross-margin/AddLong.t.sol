...
contract TestAddLong_CM is CrossMarginFixture {
    ...
    function testAddLongCallToken() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, 2 * strikePrice, 0);
    ...
    function testAddLongPutToken() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, 2 * strikePrice, 0);
