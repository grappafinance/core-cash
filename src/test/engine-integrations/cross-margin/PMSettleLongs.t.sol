...
contract TestPMSettleLongCallsCM is CrossMarginFixture {
    ...
    function testSettleMultipleLongCallsITMIncreasesCollateral() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry - 1 hours, strikePrice, 0);
    ...
    function testSettleMultipleLongCallsOTMNoIncreaseInCollateral() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry, strikePrice + (1 * UNIT), 0);
    ...
    function testSettleOnlyExpiredLongCallOTMNoIncreaseInCollateral() public {
        ...
        uint256 tokenId2 = getTokenId(SettlementType.CASH, TokenType.CALL, pidEthCollat, expiry + 1 weeks, strikePrice, 0);
...
contract TestPMSettleLongPutsCM is CrossMarginFixture {
    ...
    function setUp() public {
        ...
        tokenId = getTokenId(SettlementType.CASH, TokenType.PUT, pidUsdcCollat, expiry, strikePrice, 0);
