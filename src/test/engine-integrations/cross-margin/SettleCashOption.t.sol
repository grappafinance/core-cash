...
// solhint-disable-next-line contract-name-camelcase
contract TestSettleCashLongShort_CM is CrossMarginFixture {
    uint256 public expiry;
...
// solhint-disable-next-line contract-name-camelcase
contract TestSettleCashLongCalls_CM is CrossMarginFixture {
    uint256 public expiry;
...
// solhint-disable-next-line contract-name-camelcase
contract TestSettleCashLongPuts_CM is CrossMarginFixture {
    uint256 public expiry;
    uint256 public tokenId;
