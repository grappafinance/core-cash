...
contract FullMarginLibTest is Test {
    ...
    function testMintShortInEmptyAccount() public {
        ...
        uint256 id = TokenIdUtil.getTokenId(TokenType.CALL, SettlementType.CASH, productId, expiry, 100, 0);
    ...
    function testCannotMintOptionWithBadCollatType() public {
        ...
        uint40 productId = ProductIdUtil.getProductId(0, 0, underlyingId, strikeId, underlyingId);
        uint256 putId = TokenIdUtil.getTokenId(TokenType.PUT, SettlementType.CASH, productId, expiry, 100, 0);
        ...
        uint256 callId = TokenIdUtil.getTokenId(TokenType.CALL, SettlementType.CASH, productId, expiry, 100, 0);
        vm.expectRevert(FM_CannotMintOptionWithThisCollateral.selector);
        ...
        uint256 callSpread = TokenIdUtil.getTokenId(TokenType.CALL_SPREAD, SettlementType.CASH, productId, expiry, 100, 0);
        vm.expectRevert(FM_CannotMintOptionWithThisCollateral.selector);
    ...
    function testMergeShortId() public {
        ...
        uint8 collateralId = 2;
        uint40 productId = ProductIdUtil.getProductId(0, 0, underlyingId, strikeId, collateralId);
        uint256 shortId = TokenIdUtil.getTokenId(TokenType.CALL, SettlementType.CASH, productId, expiry, 100, 0);
        uint256 longId = TokenIdUtil.getTokenId(TokenType.CALL, SettlementType.CASH, productId, expiry, 120, 0);
    ...
    function testSplitSpreadId() public {
        ...
        uint8 collateralId = 2;
        uint40 productId = ProductIdUtil.getProductId(0, 0, underlyingId, strikeId, collateralId);
        uint256 spreadId = TokenIdUtil.getTokenId(TokenType.CALL_SPREAD, SettlementType.CASH, productId, expiry, 100, 120);
