...
contract MockOracle is IOracle {
    ...
    function getSpotPrice(address /*_underlying*/, address /*_strike*/) view external returns (uint256) {
        return spotPrice;
    }

    function getPriceAtExpiry(address /*_underlying*/, address /*_strike*/, uint256 /*_expiry*/ ) external view returns (uint256) {
        return expiryPrice;
    }
