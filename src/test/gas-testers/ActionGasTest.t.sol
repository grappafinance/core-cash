...
import "./SimpleMarginEngineGasTester.sol";
...
//     SimpleMarginEngineGasTester public tester;
...
//         tester = new SimpleMarginEngineGasTester(address(option), address(oracle)); // nonce 5
